...
function EndoskeletonOverlay() {
  ...
  return (
    <svg viewBox="0 0 900 900" style={{ position: 'absolute', inset: 0, width: '100%', height: '100%' }}>
      {/* skull beneath the mask */}
      ...
      {/* ribcage */}
      {ribs}
      {/* humeri — double bone lines with elbow joints */}
    ...
    <section id="the-one" style={{ padding: '0 var(--space-5) var(--space-5)' }}>
      <SheetFrame>
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: 'var(--space-6)', alignItems: 'flex-start' }}>
          {/* Subject: sketch + endoskeleton hidden lines */}
          <div style={{ flex: 'none' }}>
            <div style={{ display: 'flex', alignItems: 'stretch' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-between', padding: '26px 0 60px' }}>
            ...
            <div style={{ width: 380, marginLeft: 30 }}>
